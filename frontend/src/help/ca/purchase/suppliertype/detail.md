...
La pantalla de tipus de proveïdor permet definir i mantenir els tipus o categories que classifiquen els proveïdors (per exemple: matèries primeres, serveis, logística, equipaments). És un catàleg auxiliar que alimenta el camp 'tipus' a la fitxa de proveïdor.

## Accions disponibles

- Crear un tipus de proveïdor
- Editar un tipus existent
- Eliminar un tipus de proveïdor
