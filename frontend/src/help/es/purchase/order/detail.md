...
- Asociar albaranes de recepción
- Crear una recepción desde el pedido
- Eliminar líneas de pedido
- Cambiar el estado del ciclo de vida
...
- Si no se puede guardar el pedido, comprueba que el proveedor y la fecha estén informados.
- Si las líneas no se pueden añadir, revisa que haya materiales con tarifas definidas por el proveedor.
