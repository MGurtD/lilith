...
import { SalesOrderExternalService } from "../types";
import { Supplier } from "../../purchase/types";
import { formatCurrency } from "../../../utils/functions";

export interface SalesOrderExternalServiceRow extends SalesOrderExternalService {
  availableSuppliers: Supplier[];
}

defineProps<{
  externalServices: SalesOrderExternalServiceRow[];
}>();

const emit = defineEmits<{
  (e: "supplierChange", row: SalesOrderExternalServiceRow): void;
}>();

const onSupplierChange = (row: SalesOrderExternalServiceRow) => {
