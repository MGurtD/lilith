  ...
  ca: {
    ...
    apiKeys: {
      ...
      disable: {
        ...
        confirmMessage: "Segur que vols desactivar la clau \"{name}\"? No es podrà tornar a activar.",
  ...
  es: {
    ...
    apiKeys: {
      ...
      disable: {
        ...
        confirmMessage: "¿Seguro que quieres desactivar la clave \"{name}\"? No se podrá volver a activar.",
        confirmAccept: "Desactivar",
  ...
  en: {
    ...
    apiKeys: {
      ...
      disable: {
        ...
        confirmMessage: "Are you sure you want to disable the key \"{name}\"? It cannot be re-enabled.",
