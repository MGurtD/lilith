...
namespace Application.Services.Purchase
{
    public class PurchaseInvoiceService : IPurchaseInvoiceService
    {
        ...
        public IEnumerable<PurchaseInvoice> GetFiltered(DateTime startDate, DateTime endDate, Guid? supplierId, Guid? statusId, Guid? excludeStatusId, Guid? paymentMethodId, DateTime? dueDateStartTime, DateTime? dueDateEndTime, string? accountNumber)
        {
            var invoices = _unitOfWork.PurchaseInvoices.Find(p =>
                ...
                && (accountNumber == null || (p.Supplier != null && p.Supplier.AccountNumber == accountNumber))
