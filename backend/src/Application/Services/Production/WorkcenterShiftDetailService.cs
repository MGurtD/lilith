...
{
    public class WorkcenterShiftDetailService(IUnitOfWork unitOfWork, IMetricsService metricsService, IWorkOrderPhaseService workOrderPhaseService, IWorkOrderPhaseCloseChannel phaseCloseChannel, ILocalizationService localizationService, ILogger<WorkcenterShiftDetailService> logger) : IWorkcenterShiftDetailService
    {
        ...
        public async Task<GenericResponse> WorkOrderPhaseOut(WorkOrderPhaseOutRequest request)
        {
            ...
            await phaseCloseChannel.EnqueueAsync(new WorkOrderPhaseCloseRequest
            {
                WorkOrderPhaseId = request.WorkOrderPhaseId,
