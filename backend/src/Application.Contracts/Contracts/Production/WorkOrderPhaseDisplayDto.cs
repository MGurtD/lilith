...
public class BillOfMaterialsItemDto
{
    ...
    /// <summary>Required width</summary>
    public decimal Width { get; set; }

    /// <summary>Required length</summary>
    public decimal Length { get; set; }

    /// <summary>Required height</summary>
    public decimal Height { get; set; }

    /// <summary>Required diameter</summary>
    public decimal Diameter { get; set; }

    /// <summary>Required thickness</summary>
