...
namespace Application.Contracts
{
    public interface IPurchaseInvoiceService
    {
        ...
        IEnumerable<PurchaseInvoice> GetFiltered(DateTime startDate, DateTime endDate, Guid? supplierId, Guid? statusId, Guid? excludeStatusId, Guid? paymentMethodId, DateTime? dueDateStartTime, DateTime? dueDateEndTime, string? accountNumber);
