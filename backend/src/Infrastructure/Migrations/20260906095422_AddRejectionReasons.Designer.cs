...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260906095422_AddRejectionReasons")]
    partial class AddRejectionReasons
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Contracts.ConsolidatedExpense", b =>
                {
            ...
            modelBuilder.Entity("Application.Contracts.ConsolidatedIncomes", b =>
                {
                    b.Property<decimal>("Amount")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Application.Contracts.DetailedWorkOrder", b =>
                {
            ...
            modelBuilder.Entity("Application.Contracts.ProductionCost", b =>
                {
                    b.Property<DateTime>("Date")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Application.Contracts.SalesInvoiceDetailReport", b =>
                {
                    b.Property<decimal>("Amount")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Application.Contracts.WorkcenterShiftHistorical", b =>
                {
                    ...
                    b.Property<decimal>("EstimatedMachineCost")
                        .HasColumnType("numeric");

                    b.Property<decimal>("EstimatedMachineTime")
                        .HasColumnType("numeric");

                    b.Property<decimal>("EstimatedOperatorCost")
                        .HasColumnType("numeric");
                    ...
                    b.Property<bool>("IsPreferredWorkcenter")
                        .HasColumnType("boolean");
                    ...
                    b.ToView("vw_workcentershift_historical", (string)null);
                });

            modelBuilder.Entity("Application.Contracts.WorkcenterShiftHistoricalOperator", b =>
                {
                    b.Property<DateTime?>("EndTime")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Domain.Entities.Production.PhaseTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_PhaseTemplate");

                    b.ToTable("PhaseTemplate", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.Production.PhaseTemplateDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_PhaseTemplateDetail");

                    b.HasIndex("MachineStatusId");

                    b.HasIndex("PhaseTemplateId");

                    b.ToTable("PhaseTemplateDetail", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Production.RejectionReason", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.Production.WorkOrderPhaseRejection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("WorkcenterShiftDetailId")
                        .HasColumnType("uuid");

                    b.HasKey("Id")
                        .HasName("PK_WorkOrderPhaseRejections");

                    b.HasIndex("RejectionReasonId")
                        .HasDatabaseName("IX_WorkOrderPhaseRejections_RejectionReasonId");

                    b.HasIndex("WorkOrderPhaseId")
                        .HasDatabaseName("IX_WorkOrderPhaseRejections_WorkOrderPhaseId");

                    b.HasIndex("WorkcenterShiftDetailId");

                    b.ToTable("WorkOrderPhaseRejections", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Production.Workcenter", b =>
                {
                    ...
                    b.Property<bool>("MultiWoAvailable")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Domain.Entities.Shared.LifecycleTag", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK_LifecycleTags");

                    b.HasIndex("LifecycleId", "Name")
                        .IsUnique()
                        .HasDatabaseName("IX_LifecycleTags_LifecycleId_Name");

                    b.ToTable("LifecycleTags", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Shared.StatusLifecycleTag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("LifecycleTagId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_StatusLifecycleTags");

                    b.HasIndex("LifecycleTagId");

                    b.HasIndex("StatusId", "LifecycleTagId")
                        .IsUnique()
                        .HasDatabaseName("IX_StatusLifecycleTags_StatusId_LifecycleTagId");

                    b.ToTable("StatusLifecycleTags", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Production.PhaseTemplateDetail", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Production.PhaseTemplate", "PhaseTemplate")
                        .WithMany("Details")
            ...
            modelBuilder.Entity("Domain.Entities.Production.WorkOrderPhaseRejection", b =>
                {
                    b.HasOne("Domain.Entities.Production.RejectionReason", "RejectionReason")
                        .WithMany()
                    ...
                    b.HasOne("Domain.Entities.Production.WorkcenterShiftDetail", "WorkcenterShiftDetail")
                        .WithMany()
                        .HasForeignKey("WorkcenterShiftDetailId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("WorkcenterShiftDetail");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Shared.StatusLifecycleTag", b =>
                {
                    b.HasOne("Domain.Entities.Shared.LifecycleTag", "LifecycleTag")
                        .WithMany("StatusTags")
                        .HasForeignKey("LifecycleTagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Status", "Status")
                        .WithMany("LifecycleTags")
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LifecycleTag");
